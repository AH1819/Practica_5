                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <strong> <?php if(!isset($_SESSION['mensaje'])){
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="../tables/ConnDataBase/insert.php" method="POST"
                                    enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nombre completo</label>
                                            <input type="text" class="form-control" id="InputName"
                                                placeholder="Ingrese el nombre completo" name="Nombre">
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="InputFech">Fecha de nacimiento</label>
                                                    <input type="date" class="form-control" id="InputFech"
                                                        name="Fech_nac">
                                                </div>
                                                <div class="col-6">
                                                    <label for="InputYears">Edad:</label>
                                                    <input type="number" id="InputYears" name="Year" min="18"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="InputBach">Bachillerato:</label>
                                                    <input type="text" id="InputBach" name="Bachillerato"
                                                        class="form-control">
                                                </div>
                                                <div class="col-6">
                                                    <label for="InputProm">Promedio:</label>
                                                    <input type="number" id="InputProm" name="Promedio"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label class="form-text">Municipio:</label>
                                                ...
                                                <div class="col-6">
                                                    <Label class="form-text">Posee una certificacion:</Label>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio1" value="Si"
                                                                    name="customRadio" class="custom-control-input">
                                                                <label class="custom-control-label"
                                                                    for="customRadio1">Si</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio2" value="No"
                                                                    name="customRadio" class="custom-control-input">
                                                                <label class="custom-control-label"
